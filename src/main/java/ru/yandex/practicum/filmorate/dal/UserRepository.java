...
public class UserRepository extends BaseRepository<User> {
    ...
    public User save(User user) {
        long id = insert(ADD_USER_QUERY, user.getLogin(), user.getName(), user.getBirthday(), user.getEmail());
        user.setId(id);
        return user;
    }

    public User update(User user) {
        this.update(UPDATE_USER_QUERY, user.getLogin(), user.getName(), user.getBirthday(), user.getEmail(), user.getId());
